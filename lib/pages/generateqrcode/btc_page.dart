...
class BTCPage extends StatefulWidget {
  ...
  const BTCPage({Key? key, this.title = "Bitcoin"}) : super(key: key);
...
class _BTCPageState extends State<BTCPage> {
  ...
  FocusNode walletNode = FocusNode();
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  txtField(walletController, AppLocalizations.of(context)!.btcaddress, Icons.account_balance_wallet_outlined,
                      TextInputType.text, focusNode: walletNode, nextNode: amountNode,),
                      txtField(amountController , AppLocalizations.of(context)!.amount, Icons.currency_bitcoin_outlined,
                      TextInputType.phone, focusNode: amountNode, nextNode: msgNode,),
...
genCount++;
                      ...
                      String msg = "bitcoin:${walletController.text}?amount=${amountController.text}&message=${msgController.text}";
                      Scan scan = Scan(text: msg, type: 'generated');
                      generateQR(
                        context,
                        scan,
                      );
